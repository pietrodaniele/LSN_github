...
public:
  ...
  // methods: costruisco i vari metodi. Uno per fare il vettore sommato. Uno per gli accumuli ecc...
	...
	void cicleblock_buffon(vector<double>&, vector<double>&, Random&, int, int, double, double); // Metodo simile a cicleblock ma implementato per l'esperimento buffom
	void errorprog(vector<double>&, vector<double>&, vector<double>&);
};
