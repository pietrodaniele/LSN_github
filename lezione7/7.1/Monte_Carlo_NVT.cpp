...
// contribution to energy and virial
  ...
  WriteInsta << walker[iv]/(double)npart+vtail << " " << rho * temp + (walker[iw] + ptail/(double)npart) / vol << endl;
  WriteInsta.close();
}
